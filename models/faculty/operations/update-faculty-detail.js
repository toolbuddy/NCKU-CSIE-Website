...
const AwardValidationConstraints = require('models/faculty/constraints/update/award.js');
const AwardI18nValidationConstraints = require('models/faculty/constraints/update/award-i18n.js');
const ConferenceValidationConstraints = require('models/faculty/constraints/update/conference.js');
const ConferenceI18nValidationConstraints = require('models/faculty/constraints/update/conference-i18n.js');
const EducationValidationConstraints = require('models/faculty/constraints/update/education.js');
const EducationI18nValidationConstraints = require('models/faculty/constraints/update/education-i18n.js');
const ExperienceValidationConstraints = require('models/faculty/constraints/update/experience.js');
const ExperienceI18nValidationConstraints = require('models/faculty/constraints/update/experience-i18n.js');
const PatentValidationConstraints = require('models/faculty/constraints/update/patent.js');
const PatentI18nValidationConstraints = require('models/faculty/constraints/update/patent-i18n.js');
...
const ProjectValidationConstraints = require('models/faculty/constraints/update/project.js');
const ProjectI18nValidationConstraints = require('models/faculty/constraints/update/project-i18n.js');
const PublicationValidationConstraints = require('models/faculty/constraints/update/publication.js');
const PublicationI18nValidationConstraints = require('models/faculty/constraints/update/publication-i18n.js');
const SpecialtyValidationConstraints = require('models/faculty/constraints/update/specialty.js');
const SpecialtyI18nValidationConstraints = require('models/faculty/constraints/update/specialty-i18n.js');
const StudentValidationConstraints = require('models/faculty/constraints/update/student.js');
const StudentI18nValidationConstraints = require('models/faculty/constraints/update/student-i18n.js');
const StudentAwardValidationConstraints = require('models/faculty/constraints/update/student-award.js');
const StudentAwardI18nValidationConstraints = require('models/faculty/constraints/update/student-award-i18n.js');
const TechnologyTransferValidationConstraints = require('models/faculty/constraints/update/technology-transfer.js');
const TechnologyTransferI18nValidationConstraints = require('models/faculty/constraints/update/technology-transfer-i18n.js');
const TechnologyTransferPatentValidationConstraints = require('models/faculty/constraints/update/technology-transfer-patent.js');
const TechnologyTransferPatentI18nValidationConstraints = require('models/faculty/constraints/update/technology-transfer-patent-i18n.js');
