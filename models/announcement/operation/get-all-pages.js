...
/**
 * @summary A function for getting the number of pages to display all the requested announcements.
 * @description Announcements which contain at least one of the given tags are taken into account.
 * 
