...
import { pageButtonOnClick, } from 'jsComponent/announcement/event-listener.js';
...
export async function getAllAnnouncements ( {
    ...
    // Append tags
    qS.defaultTags.forEach( tag => queryString.append( 'tags', tag ) );
...
export async function getPageNumberByTags ( { tags = qS.getTags(), startTime = qS.getStartTime(), endTime = qS.getEndTime(), } = { } ) {
    // Need injection protection
    const queryString = new URLSearchParams();
