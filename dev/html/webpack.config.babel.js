...
export default LanguageUtils.supportedLanguageId.map( languageId => ( {
    ...
    entry:   {
        ...
        'user/profile':            path.join( pugRoot, 'user/faculty/profile.pug' ),
        'user/award':              path.join( pugRoot, 'user/faculty/award.pug' ),
        'user/publication':        path.join( pugRoot, 'user/faculty/publication.pug' ),
        'user/conference':         path.join( pugRoot, 'user/faculty/conference.pug' ),
        'user/project':            path.join( pugRoot, 'user/faculty/project.pug' ),
        'user/patent':             path.join( pugRoot, 'user/faculty/patent.pug' ),
        'user/studentAward':       path.join( pugRoot, 'user/faculty/studentAward.pug' ),
        'user/technologyTransfer': path.join( pugRoot, 'user/faculty/technologyTransfer.pug' ),
