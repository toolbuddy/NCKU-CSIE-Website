...
export default {
    ...
    entry:   {
        ...
        'user/profile':            path.join( jsSrcRoot, 'user/faculty/profile.js' ),
        'user/award':              path.join( jsSrcRoot, 'user/faculty/award.js' ),
        'user/publication':        path.join( jsSrcRoot, 'user/faculty/publication.js' ),
        'user/conference':         path.join( jsSrcRoot, 'user/faculty/conference.js' ),
        'user/project':            path.join( jsSrcRoot, 'user/faculty/project.js' ),
        'user/patent':             path.join( jsSrcRoot, 'user/faculty/patent.js' ),
        'user/studentAward':       path.join( jsSrcRoot, 'user/faculty/studentAward.js' ),
        'user/technologyTransfer': path.join( jsSrcRoot, 'user/faculty/technologyTransfer.js' ),
